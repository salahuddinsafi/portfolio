              ...
              >
                ...
                <div className="absolute left-4 md:left-1/2 w-8 h-8 -translate-x-1/2 rounded-full bg-white border-2 border-blue-500 flex items-center justify-center z-10">
                  ...
                  <div className="ml-16 md:ml-0 md:w-[calc(50%-2rem)]">
                    <div className="bg-white dark:bg-gray-900 shadow-md reounded-xl p-6 hover:scale-105 transition-100 duration-300">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {
                                item.technologies.map((tech) => {
                                    return (
                                        <span className="text-sm px-2 py-1 rounded-md bg-indigo-500 text-white">
                                            {tech}
                                        </span>
                                    );
                                })
